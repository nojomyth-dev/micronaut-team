...
class MissionControllerTest {
    ...
    void getMissions_returnsMissionsFromRepository() {
        ...
        // Still only one pending mission (service reuses instead of generating a new
        // one)
    ...
    void getMissions_returnsEmptyCollection_whenNoMissionsExist() {
        ...
        // This test verifies the "no missions exist" behavior: one gets generated and
        // persisted.
    ...
    void completeMission_returns200_andMarksMissionAsCompleted() {
        // Note: completion marks the mission as COMPLETED; it is not removed from the
        // repository.
